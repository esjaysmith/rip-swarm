...
**Status:** v0 is implemented on `master`. Ready for a two-harness trial on one Linux/macOS project. Windows is out of scope. Marketplace pin, Grok Bot bridge, and lookback opening a PR are not in v0.
