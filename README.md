...
**Discussion:** [docs/specs/2026-09-17-hive-checkout.md](docs/specs/2026-09-17-hive-checkout.md) — `swarm` branch vs worktree vs nested clone (option C locked).  
**Review:** [docs/plans/2026-09-17-implementation-review.md](docs/plans/2026-09-17-implementation-review.md) — v0 runtime vs spec v0.2, with dispositions.
